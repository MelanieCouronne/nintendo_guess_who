...
ActiveRecord::Schema.define(version: 2022_02_22_161609) do
  ...
  create_table "games", force: :cascade do |t|
    ...
    t.integer "user_rejected_characters", default: [], array: true
    t.bigint "user_id", null: false
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.bigint "computer_character_id", null: false
    t.bigint "user_character_id", null: false
    t.integer "computer_rejected_characters", default: [], array: true
